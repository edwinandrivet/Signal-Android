...
public class SingleRecipientDeliveryNotificationBuilder extends AbstractNotificationBuilder {

  private static final String TAG = SingleRecipientDeliveryNotificationBuilder.class.getSimpleName();
  ...
  public SingleRecipientDeliveryNotificationBuilder(@NonNull Context context, @NonNull NotificationPrivacyPreference privacy)
  {
    ...
    setContentTitle("Accusé de réception");
